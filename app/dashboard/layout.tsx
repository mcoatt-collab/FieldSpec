...
export default function DashboardLayout({
  ...
  const handleLogout = async () => {
    ...
    // Prefetch login page just in case it's not ready
    router.prefetch("/login");
    try {
      await fetch("/api/auth/logout", { method: "POST" });
      // Use window.location for a "harder" and often faster reset of the app state on logout
  ...
  // Prefetch login page on mount to make logout instant
  useEffect(() => {
    router.prefetch("/login");
  }, [router]);
